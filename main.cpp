...
#define resulttxt "/Users/pjl/ClionProjects/untitled/t10k-images/result.txt"


void readD(){
    char *dir="/Users";
    DIR  *resDir=opendir(dir);
    cout<<"A"<<endl;
    cout<<resDir->__dd_flags<<endl;
}
void buildImg()
{
    BoxExtractor box;
    Mat res = box.MouseDraw ("draw",Mat(400,400,CV_8UC3,Scalar(0,0,0)),Scalar(255,255,255),18);
    imwrite ("/Users/pjl/ClionProjects/untitled/test.jpg",res);
}
...
void testTrain()
{
    ...
    //保存训练好的分类器
    std::cout<<"saving... ... !!! \n "<<endl;
    svm.save( "/Users/pjl/ClionProjects/untitled/HOG_SVM_DATA.xml" );
...
void testPredict(){
    ...
    CvSVM svm;
    svm.load("/Users/pjl/ClionProjects/untitled/HOG_SVM_DATA.xml");//加载训练好的xml文件，这里训练的是10K个手写数字
    //检测样本
    test = cvLoadImage("/Users/pjl/ClionProjects/untitled/test.jpg", 1); //待预测图片，用系统自带的画图工具随便手写
    if (!test)
    {
        cout<<"not exist"<<endl;
        return ;
